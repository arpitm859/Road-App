	...
	return (
		<div>
			<form className={classes.root} noValidate>
				<h2 style={{ color: '#454749' , textAlign:'center',padding:'0.5rem'}}> Application to lodge a Complaint </h2>
				<div >
					<Divider orientation="left" style={{fontSize:'22px'}}>Define Nature of the Complaint</Divider>
					<div className="rowC" >
				...
				<Divider orientation="left" style={{fontSize:'22px'}}>Description of the Complaint</Divider>
				<div style={{paddingTop:'1rem'}}>
					...
					<Divider orientation="left" style={{fontSize:'22px'}}>Location of the Complaint</Divider>
					<div className="rowC">
					<div style={{paddingLeft:'3rem'}}>
					...
					<Divider orientation="left" style={{fontSize:'22px'}}>Address of the Complainant</Divider>
					<div className="rowC">
					<div style={{paddingLeft:'3rem'}}>
						<p style={{fontSize:'18px'}}>House</p>
						<TextField
					...
					<Button type='primary' shape='round' style={{marginLeft:'40rem', marginTop:'3rem'}}>Submit</Button>
				</div>
			</form>
		</div>
	);
